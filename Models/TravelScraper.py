...
class TravelScraper:
    ...
    def scrapeTravel(self):
        ...
        if (
            listStart is None or listEnd is None or listStart is 0 or listEnd is 0
        ):  # Either of these values indicates a failed angling, generally because of an update to the Wikipedia page--if we encounter this, just terminate
            print("empty")
            return None
